...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "fossilcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"fossilcointools.com", "dnsseed.fossilcointools.com"},
    {"fossilcoinpool.org", "dnsseed.fossilcoinpool.org"},
    {"xurious.com", "dnsseed.FOS.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"fossilcointools.com", "testnet-seed.fossilcointools.com"},
    {"xurious.com", "testnet-seed.FOS.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. fossilcoin is probably already running."), addrBind.ToString().c_str());
        else
